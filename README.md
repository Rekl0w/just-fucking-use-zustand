...
A brutally honest, aggressively styled single-page website that tells you why you should stop overthinking and just use [Zustand](https://github.com/pmndrs/zustand) for state management.

## 🤬 What the fuck is this?

This is a parody/tribute site inspired by [justfuckingusehtml.com](https://justfuckingusehtml.com) and [justfuckingusereact.com](https://justfuckingusereact.com), but for Zustand - the tiny, fast, and scalable state management library that doesn't give a fuck about your Redux trauma.
...
Because:
1. Zustand is fucking amazing and more people should use it
2. Redux boilerplate is driving developers insane
3. Context API makes everything re-render like it's 1999
4. The internet needs more aggressive educational content
5. Bears are cool
...
- **Zustand** - Created by the talented folks at [Poimandres](https://github.com/pmndrs)
...
- [Live Site](https://justfuckingusezustand.com)
